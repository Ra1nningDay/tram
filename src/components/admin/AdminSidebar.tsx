...
export function AdminSidebar({ open, onClose }: AdminSidebarProps) {
  ...
  const sidebarContent = (
    <div
      data-admin-sidebar
      className="admin-panel rounded-none border-0 flex h-full lg:h-screen flex-col p-4 sm:p-5 lg:sticky lg:top-0 lg:overflow-y-auto lg:px-0 lg:py-0 lg:shadow-none shrink-0"
    >
