...
export function AdminHeader({ user }: AdminHeaderProps) {
  ...
  return (
    <header className="admin-panel px-4 py-4 sm:px-5 md:px-6 lg:sticky lg:top-0 lg:z-20 lg:rounded-none lg:border-0 lg:border-b lg:border-[var(--admin-panel-border)] lg:shadow-none">
